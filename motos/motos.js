...
let index = 0;
let bikeStatus = [
   {engineModel:`4 tempos, 4 cilindros em linha, 16V, DOHC`,enginePower:`210 cv/999 cc`,torque:`11,52 Ngm`,transmission:`Caixa de 6 velocidades`,weight:`175,5 kg`,fuelTank:`17,5 L`,curiosities:['Design inspirado no "Predador": A BMW S1000RR possui um design agressivo e único, com luzes assimétricas em forma de "olhos" que lembram a criatura alienígena.',
   'Controle de tração avançado: Equipada com um sistema eletrônico de controle de tração, a S1000RR ajusta a potência e o freio motor para otimizar a tração em diferentes condições de pilotagem.',
   'Sucesso nas pistas: A S1000RR conquistou vitórias e títulos no Campeonato Mundial de Superbike, demonstrando seu domínio nas competições de superbike.',
   'Tecnologia de ponta: Com recursos como painel digital, modos de pilotagem, quick-shifter bidirecional e suspensão eletrônica, a S1000RR oferece uma experiência de pilotagem avançada.',
   'Leveza e desempenho: Apesar de sua potência, a S1000RR é leve graças ao uso de materiais como alumínio e fibra de carbono, proporcionando agilidade e alto desempenho.']},
...
function createRightDiv(index) {
   ...
   for(i = 0;i<5;i++){
      ...
      li.innerText = bikeStatus[0].curiosities[i]
      ul.appendChild(li)
   }
   div.append(h3,ul)
   return div
